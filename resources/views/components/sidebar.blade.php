    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-zinc-800">
        ...
        <ul class="space-y-2 text-sm" id="sidebar-menu">
            @if (Auth::user()->role == 'superadmin')
                ...
                <x-dropdown-nav :active="$isActive->is('user*')" :open="request()->is('*user*')" id="dropdown-user">
                    <x-slot name="icon">
                    ...
                    <x-slot name="label">Data Pengguna</x-slot>

                    <x-link-dropdown :href="route('user.index')" :active="$isActive->is('*user')">
                        Daftar Pengguna
                    </x-link-dropdown>

                    <x-link-dropdown :href="route('user.create')" :active="$isActive->is('*user/create')">
                        Tambah Pengguna
                    </x-link-dropdown>
                </x-dropdown-nav>
