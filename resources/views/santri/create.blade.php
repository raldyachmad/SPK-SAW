    ...
    <section class="bg-white dark:bg-zinc-800 p-4 rounded-md border border-zinc-200 dark:border-zinc-700">
        <form action="{{ route('santri.store') }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 md:gap-4">
                ...
                <div>
                    <label for="jenis-kelamin" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white after:ml-0.5 after:text-red-500 after:content-['*']">Jenis Kelamin</label>
