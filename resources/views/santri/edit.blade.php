<x-layout>
    ...
    <nav class="mb-4 flex items-center text-sm text-gray-500 dark:text-gray-400">
        ...
        <svg class="w-4 h-4 mx-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <a href="{{ route('santri.edit') }}" class="flex items-center gap-1 hover:underline">
            Edit Santri
        </a>
    </nav>
    <section class="bg-white dark:bg-zinc-800 p-4 rounded-md border border-zinc-200 dark:border-zinc-700">
        ...
        <form action="{{ route('santri.store') }}">
            @csrf
            <div class="grid md:grid-cols-2 md:gap-4">
                <div class="mb-6">
                    <label for="default-input" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white">
                        Nama Lengkap</label>
