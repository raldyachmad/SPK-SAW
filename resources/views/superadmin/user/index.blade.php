                ...
                <table class="w-full text-sm text-left text-zinc-500 dark:text-zinc-400" id="pagination-table">
                    <thead class="text-xs text-zinc-700 uppercase bg-zinc-50 dark:bg-zinc-700 dark:text-zinc-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-3">
                                <span class="flex items-center">
                                    Nama Pengguna <svg class="w-4 h-4 ms-1" aria-hidden="true"
                            ...
                            <th scope="col" class="px-4 py-3">
                                <span class="flex items-center">
                                    Email <svg class="w-4 h-4 ms-1" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4" />
                            ...
                            <th scope="col" class="px-4 py-3">
                                <span class="flex items-center">
                                    Role <svg class="w-4 h-4 ms-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        width="24" height="24" fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4" />
                                    </svg>
                            ...
                            <th scope="col" class="px-4 py-3">
                                <span class="flex items-center">
                                    Status <svg class="w-4 h-4 ms-1" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4" />
                            ...
                            <th scope="col" class="px-4 py-3">
                                <span class="flex items-center">
                                    Tanggal Dibuat <svg class="w-4 h-4 ms-1" aria-hidden="true"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                                        viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m8 15 4 4 4-4m0-6-4-4-4 4" />
                        ...
                        @forelse ($users as $user)
                            <tr class="border-b border-zinc-200 dark:border-zinc-700" x-data="{ showHapus: false }">
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="user-{{ $user->id }}-button"
                                        data-dropdown-toggle="user-{{ $user->id }}"
                                    ...
                                    <div id="user-{{ $user->id }}"
                                        ...
                                        <ul class="py-1 text-sm text-zinc-700 dark:text-zinc-200"
                                            aria-labelledby="user-{{ $user->id }}-button">
                                            <li>
                                            ...
                                            <div class="relative p-4 bg-white rounded-lg dark:bg-zinc-800 md:p-8">
                                                <div class="mb-4 text-sm font-light text-zinc-500 dark:text-zinc-400">
                                                    <h3 class="mb-3 text-2xl font-bold text-zinc-900 dark:text-white">
                                                        Yakin Ingin Menghapus Data?<br>({{ $user->name }})</h3>
                                                    <p>
