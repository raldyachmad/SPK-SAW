    ...
    <section class="bg-white dark:bg-zinc-800 p-4 rounded-md border border-zinc-200 dark:border-zinc-700">
        <form action="{{ route('user.update', $user->id) }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 md:gap-4">
                <div>
                    <label for="name" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white after:ml-0.5 after:text-red-500 after:content-['*']">Nama Lengkap</label>
                ...
                <div>
                    <label for="email" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white after:ml-0.5 after:text-red-500 after:content-['*']">Email</label>
                ...
                <div>
                    <label for="password" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white">
                ...
                <div>
                    <label for="password_confirmation" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white">
                        Konfirmasi Password
                    </label>
                ...
                <div class="md:col-span-2">
                    <label for="role" class="block mb-2 text-sm font-medium text-zinc-900 dark:text-white after:ml-0.5 after:text-red-500 after:content-['*']">Role</label>
